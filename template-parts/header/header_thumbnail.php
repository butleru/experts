<?php
/**
 * Template part for displaying a page's featured image
 *
 * @package wp_rig
 */
...
if ( is_singular( get_post_type() ) ) {
	?>
	<div class="post-thumbnail page-featured-image">
		<?php the_post_thumbnail( 'wp-rig-page-featured', [ 'class' => 'skip-lazy' ] ); ?>
	</div><!-- .post-thumbnail -->
	<?php
} else {
	?>
