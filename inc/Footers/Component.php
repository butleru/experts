<?php
/**
 * WP_Rig\WP_Rig\Footers\Component class
 *
 * @package wp_rig
 */

namespace WP_Rig\WP_Rig\Footers;
...
/**
 * Class for managing footer.
 *
 * Exposes template tags:
 * * `wp_rig()->is_footer_sidebar_active()`
 * * `wp_rig()->display_footer_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function initialize() {
		add_action( 'widgets_init', [ $this, 'action_register_footers' ] );
	...
	/**
	 * Adds custom classes to indicate whether a footer sidebar is present to the array of body classes.
	 *
	 * @param array $classes Classes for the body element.
	 * @return array Filtered body classes.
	 */
	public function filter_body_classes( array $classes ) : array {
		if ( $this->is_footer_sidebar_active() ) {
			global $template;
