<?php
/**
 * Customizer Sortable Repeater Custom Controls
 *
 * @package wp_rig
 */
 ...
 */
class Butler_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
	/**
	 ...
	 * Constructor
	 *
	 * @param string $manager wp customize.
	...
	public function render_content() {
		...
		<div class="sortable_repeater_control">
			...
			<button class="button customize-control-sortable-repeater-add" type="button"><?php echo $this->button_labels['add']; /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */ ?></button>
		</div>
		<?php
	}
	/**
	 * Take a string of url's sanitize them and convert to array
	 *
	 * @param string $input string of url's.
	 */
	public function butler_url_sanitization( $input ) {
